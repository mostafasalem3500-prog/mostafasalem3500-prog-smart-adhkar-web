const CACHE='smart-adhkar-v5';
const ASSETS=['/','/styles.css','/v11.css','/v12.css','/v13.css','/app.js','/v12.js','/v13.js','/adhkar-1.json','/adhkar-2.json','/adhkar-3.json','/adhkar-4.json','/manifest.webmanifest','/icon.svg'];
