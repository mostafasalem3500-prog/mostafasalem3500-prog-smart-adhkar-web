...
http.createServer((req,res)=>{
  ...
  if(pathname === '/health'){res.writeHead(200,{'content-type':'application/json'});return res.end(JSON.stringify({ok:true,service:'smart-adhkar-web',version:'1.9.0'}));}
  ...
  fs.stat(file,(err,stat)=>{
    ...
    if(pathname==='/index.html'){
      fs.readFile(file,'utf8',(e,html)=>{
        if(e)return res.end('');
        const styles=['/v13.css','/v14.css','/v15.css','/v16.css','/v17.css','/v18.css','/v19.css'];
        styles.forEach(href=>{if(!html.includes(href))html=html.replace('</head>',`<link rel="stylesheet" href="${href}"></head>`)})
        const scripts=['/v12.js','/v13.js','/v14.js','/v15.js','/v16.js','/v17.js','/v18.js','/v19.js'];
...
}).listen(process.env.PORT||3000,'0.0.0.0',()=>console.log('Smart Adhkar web v1.9.0 running'));
