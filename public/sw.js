const CACHE='smart-adhkar-v9';
const ASSETS=['/','/styles.css','/v11.css','/v12.css','/v13.css','/v14.css','/v15.css','/v16.css','/app.js','/v12.js','/v13.js','/v14.js','/v15.js','/v16.js','/adhkar-1.json','/adhkar-2.json','/adhkar-3.json','/adhkar-4.json','/manifest.webmanifest','/icon.svg','/privacy.html'];
