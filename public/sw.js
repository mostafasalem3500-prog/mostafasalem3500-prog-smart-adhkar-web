const CACHE='smart-adhkar-v8';
const ASSETS=['/','/styles.css','/v11.css','/v12.css','/v13.css','/v14.css','/v15.css','/app.js','/v12.js','/v13.js','/v14.js','/v15.js','/adhkar-1.json','/adhkar-2.json','/adhkar-3.json','/adhkar-4.json','/manifest.webmanifest','/icon.svg','/privacy.html'];
