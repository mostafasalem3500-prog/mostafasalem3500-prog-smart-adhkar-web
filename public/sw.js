const CACHE='smart-adhkar-v3';
const ASSETS=['/','/styles.css','/v11.css','/app.js','/adhkar-1.json','/adhkar-2.json','/adhkar-3.json','/adhkar-4.json','/manifest.webmanifest','/icon.svg'];
