const CACHE='smart-adhkar-v17-unified';
const ASSETS=['/','/styles.css','/v11.css','/v24.css','/app.js','/v24.js','/adhkar-1.json','/adhkar-2.json','/adhkar-3.json','/adhkar-4.json','/manifest.webmanifest','/icon.svg','/privacy.html'];
