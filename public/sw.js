const CACHE='smart-adhkar-v15-stable';
const ASSETS=['/','/styles.css','/v11.css','/v22.css','/app.js','/v22.js','/adhkar-1.json','/adhkar-2.json','/adhkar-3.json','/adhkar-4.json','/manifest.webmanifest','/icon.svg','/privacy.html'];
